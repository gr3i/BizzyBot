...
class RoleInfo(commands.Cog):
    ...
    async def role(self, interaction: Interaction):
        ...
        example_roles = [
            ...
            ("**Vyucujici/Zamestnanec**", "Role pro vyučující/zaměstnance VUT."),  
        ]
