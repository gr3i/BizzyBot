...
class Reviews(commands.Cog):
    ...
    async def zobraz_hodnoceni(self, interaction: discord.Interaction, predmet: str):
        ...
        if not rows:
            await interaction.response.send_message(f"Pro předmět **{predmet}** zatím nejsou žádná hodnocení. Můžeš být první a nějakou napsat. <:huggers:1379563250307563550>", ephemeral=False)
            return
