...
class Reviews(commands.Cog):
    ...
    async def zobraz_hodnoceni(self, interaction: discord.Interaction, predmet: str):
        ...
        if not rows:
            await interaction.response.send_message(f"Pro předmět **{predmet}** zatím nejsou žádná hodnocení. Můžeš být první a nějakou napsat. <:koteseni:1469718679309779054>", ephemeral=False)
            return
